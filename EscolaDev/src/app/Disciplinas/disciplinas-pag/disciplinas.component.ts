...
// validaCargaHoraria() {
//   // Validar carga horária da disciplina
//   if (this.cargaHorariaDisciplina === 0 || this.cargaHorariaDisciplina < 20) {
//     console.log(
//       'False! Carga horária da disciplina não pode ser 0 ou menor que 20.'
//     );
//     return false;
//   }
//   return true;
